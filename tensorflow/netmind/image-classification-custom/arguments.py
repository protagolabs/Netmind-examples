...
def setup_args():
    ...
    parser.add_argument('--data', default='/tf/tiny-imagenet-200/train', type=str, required=False,
                        help='data directory')
    ...
    parser.add_argument('--val_data', default='/tf/tiny-imagenet-200/val', type=str, required=False,
